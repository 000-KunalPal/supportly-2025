...
const SYSTEM_PROMPTS = {
  image:
    "You turn images into text. If it is a photo of a document, transcribe it. If it is now a document, describe it.",
  pdf: "You transform PDFs into text.",
...
export async function extractTextContent(
  ...
  if (SUPPORT_IMAGE_TYPES.some((type) => type === mediaType)) {
    ...
    messages: [
      {
        role: "user",
        content: [
          { type: "file", data: new URL(url), filename, mediaType: mediaType },
          {
            type: "text",
