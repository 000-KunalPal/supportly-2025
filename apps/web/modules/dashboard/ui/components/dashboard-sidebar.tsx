  ...
  return (
    <Sidebar className='group' collapsible='icon'>
      ...
      <SidebarContent>
        ...
        {/* Configuration */}
        <SidebarGroup>
          <SidebarGroupLabel>Configration</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
            ...
            <UserButton
              ...
              appearance={{
                elements: {
                  ...
                  userButtonBox:
                    "w-full! justify-end! flex-row-reverse! gap-2! group-data-[collapsible=icon]:justify-center! text-sidebar-foreground!",
