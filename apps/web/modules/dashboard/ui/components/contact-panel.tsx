...
export const ContactPanel = () => {
  ...
  }, [contactSession, userAgentInfo, conversationId]);
          ...
          >
            {accordionSection.map((section) => (
              <AccordionItem
                ...
                value={section.id}
              >
                <AccordionTrigger className='flex w-full flex-1 items-start justify-between gap-4 rounded-none bg-accent px-5 py-4 text-left text-sm font-medium transition-all outline-none hover:no-underline disabled:pointers-event-none disabled:opacity-50'>
