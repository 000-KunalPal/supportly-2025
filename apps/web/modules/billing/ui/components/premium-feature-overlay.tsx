...
import { Feature } from "@/modules/plugins/ui/components/plugin-card";
        ...
        <Card className='w-full max-w-md'>
          <CardHeader className='text-center'>
            <div className='flex items-center justify-center'>
              <div className='mb-2 inline-flex rounded-full h-12 w-12 items-center justify-center border bg-muted'>
